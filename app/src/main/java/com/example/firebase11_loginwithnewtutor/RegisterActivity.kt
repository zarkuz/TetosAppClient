...
class RegisterActivity : AppCompatActivity() {
    ...
    private var jenisk: String? = null
    ...
    private var etjk: EditText? = null
    ...
    private fun initialise() {
        ...
        etjk = findViewById<View>(R.id.et_jenisk) as EditText
    ...
    private fun createNewAccount(){
        ...
        jenisk = etjk?.text.toString()
        alamat = etalamat?.text.toString()
        email = etEmail?.text.toString()
        password = etPassword?.text.toString()
        if (!TextUtils.isEmpty(nik) && !TextUtils.isEmpty(nama)
        ...
        mAuth!!
            ...
            .addOnCompleteListener(this) { task ->
                ...
                if (task.isSuccessful) {
                    ...
                    currentUserDb.child("uidku").setValue(userId)
                    currentUserDb.child("email").setValue(email)
                    currentUserDb.child("nik").setValue(nik)
                    currentUserDb.child("nama").setValue(nama)
                    currentUserDb.child("jenisk").setValue(jenisk)
